...
import ml.nerdsofku.gminerriant.MainActivity;
import ml.nerdsofku.gminerriant.R;
import ml.nerdsofku.gminerriant.Sta;
...
public class HandleNotifications {
    ...
    public static final int SMALL_ICON = R.drawable.ic_launcher_foreground;
    public static final int STOP_ACTION_ICON = R.drawable.ic_launcher_foreground;

    /** PendingIntent to stop the service. */
    private static PendingIntent getStopServicePI(Service context) {
        return getLaunchActivityPI(context);
    }
